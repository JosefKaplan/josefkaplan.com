...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210419_lunhalgorithm_7f87d093ee3a7d286468_20210419115359_archive.zip';
	const ARCHIVE_SIZE		 = '44243276';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '7f87d09-19115359';
    const SECONDARY_PACKAGE_HASH = '45d3ab9-19115359';
	const VERSION			 = '1.4.0';
