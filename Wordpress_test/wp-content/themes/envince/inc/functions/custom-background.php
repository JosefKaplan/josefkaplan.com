...
add_action( 'after_setup_theme', 'envince_custom_background_setup', 15 );
 ...
 * @return void
 */
function envince_custom_background_setup() {
	...
	add_theme_support(
		...
		array(
			...
			'default-image'    => '',
			'wp-head-callback' => 'envince_custom_background_callback',
		)
	);
}
 ...
 * @return void
 */
function envince_custom_background_callback() {
