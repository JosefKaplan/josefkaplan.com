 ...
 *
 * This will show one full width post and the rest will arrange itself in two columns
 */


if( ! class_exists('Purea_Magazine_Posts_Layout_1_Widget')) :

class Purea_Magazine_Posts_Layout_1_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'purea_magazine_posts_layout_1_widget', // Base ID
			esc_html__( 'Purea Magazine: Posts Layout 1 Widget', 'purea-magazine' ), // Name
			array( 'description' => esc_html__( 'This will show one full width post and the rest will arrange itself in two columns. ', 'purea-magazine'), ) // Args
		);		     
	}
	...
	public function widget( $args, $instance ) {
		...
		<div class="posts-layout-1-wrapper">
			<?php 
			...
			?>
			<div class="posts-layout-1-lists-wrapper">
					...
					<?php
						...
						if($query-> have_posts()) : $postCount = 0;
							while( $query-> have_posts() ) : $postCount++; $query->the_post(); ?>
								<div id="post-<?php the_ID(); ?>" class="layout-1-category-post">
									<div class="layout-1-category-post-content">
										<div class="section-layout-1-area-box">
											<div class="col-first">
											...
											<div class="col-second">
												<div class="layout-1-area-content">
...
if( ! function_exists('purea_magazine_register_posts_layout_1_widget')) :
// register widget
function purea_magazine_register_posts_layout_1_widget() {
    register_widget( 'Purea_Magazine_Posts_Layout_1_Widget' );
}
endif;

add_action( 'widgets_init', 'purea_magazine_register_posts_layout_1_widget' );
