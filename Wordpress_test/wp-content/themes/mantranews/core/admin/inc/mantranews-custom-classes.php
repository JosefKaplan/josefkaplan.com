...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	class Mantranews_Customize_Category_Control extends WP_Customize_Control {
		/**
		...
		public function render_content() {
			$dropdown = wp_dropdown_categories(
				array(
					...
					'echo'              => 0,
					'show_option_none'  => esc_html__( '&mdash; Select Category &mdash;', 'mantranews' ),
					'option_none_value' => '',
					'selected'          => $this->value(),
				)
			);
	 ...
	 */
	class Mantranews_Image_Radio_Control extends WP_Customize_Control {
		...
		public function render_content() {
			...
			<ul class="controls" id="mantranews-img-container">
				<?php
				foreach ( $this->choices as $value => $label ) :
					$class = ( $this->value() == $value ) ? 'mantranews-radio-img-selected mantranews-radio-img-img' : 'travel-radio-img-img';
					?>
	 ...
	 */
	class Mantranews_Customize_Switch_Control extends WP_Customize_Control {
		public $type = 'switch';
